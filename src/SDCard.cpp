...
void SDCard::pruneZeroFiles(fs::FS* fs)
{
...
void SDCard::addPacket(uint8_t* buf, uint32_t len){
...
void SDCard::write(uint8_t* buf, uint32_t len){
  if(!writing) return;
...
void SDCard::forceSave(fs::FS* fs){
